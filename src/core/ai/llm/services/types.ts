...
export interface ILLMService {
     ...
     * Instead of waiting for the full response, this method emits events for each chunk
     ...
     */
    completeTaskStreaming(userInput: string, imageData?: ImageData): Promise<void>;
