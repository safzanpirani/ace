...
export const LLM_REGISTRY: Record<string, ProviderInfo> = {
    ...
    google: {
        models: [
            { name: 'gemini-2.5-pro-exp-05-06', maxTokens: 1048576 },
            { name: 'gemini-2.5-flash-preview-04-17', maxTokens: 1048576 },
    ...
    openrouter: {
        models: [
            { name: 'qwen/qwen3-32b:nitro', maxTokens: 32768 },
            { name: 'qwen/qwen-2.5-72b-instruct', maxTokens: 32768 },
            { name: 'anthropic/claude-3.5-sonnet', maxTokens: 200000 },
            { name: 'anthropic/claude-sonnet-4', maxTokens: 200000 },
            { name: 'anthropic/claude-3-haiku', maxTokens: 200000 },
            { name: 'openai/gpt-4o', maxTokens: 128000 },
            { name: 'openai/gpt-4o-mini', maxTokens: 128000 },
            { name: 'meta-llama/llama-3.1-405b-instruct', maxTokens: 128000 },
            { name: 'meta-llama/llama-3.1-70b-instruct', maxTokens: 128000 },
            { name: 'google/gemini-2.0-flash-exp', maxTokens: 1048576 },
        ],
    },
