...
logger.info(`Initializing Ace with config: ${normalizedConfigPath}`, null, 'blue');
...
async function startApp() {
    ...
    logger.info('===============================================');
    logger.info(`Initializing Ace in '${runMode}' mode...`, null, 'cyanBright');
    logger.info('===============================================\n');

    // Create the AceAgent instance
