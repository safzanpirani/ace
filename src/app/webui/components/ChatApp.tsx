...
export default function ChatApp() {
    ...
    const [exportName, setExportName] = useState('ace-config');
        ...
        <div className="flex h-screen bg-background">
            <main className="flex-1 flex flex-col relative">
                <header className="flex justify-between items-center p-4 border-b border-border bg-background z-10">
                    <div className="flex items-center space-x-1">
                        <img src="/logo.png" alt="Ace Logo" className="mt-1 h-7 w-7" />
                        <span className="font-semibold text-xl">Ace</span>
                    </div>
                        ...
                        <Dialog open={isExportOpen} onOpenChange={setExportOpen}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Download the current config and servers as YAML.
                                    </DialogDescription>
                                </DialogHeader>
                                {exportError && (
            ...
            <div
                className={cn(
                    ...
                    isServersPanelOpen
                        ? 'w-80 border-l border-border shadow-xl'
