...
Ace uses a YAML configuration file to define tool servers and AI settings. This guide provides detailed information on all available configuration options.

## Configuration File Location

By default, Ace looks for a configuration file at `configuration/ace.yml` in the project directory. You can specify a different location using the `--config-file` command-line option:
...
Ace supports several command-line options:
